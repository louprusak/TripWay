...
public abstract class Stub {
    ...
    private static ArrayList<Carnet> createCarnets(){
        ...
        Carnet c4=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        Carnet c5=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        Carnet c6=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        Carnet c7=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        Carnet c8=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        Carnet c9=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        Carnet c10=new Carnet("test","Juillet 2020","Angleterre","Londres",51.507334,-0.127744);
        liste.add(c1);
        liste.add(c2);
        liste.add(c3);
        liste.add(c4);
